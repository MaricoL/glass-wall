...
<body>
	<form>
		<div class='main_title'>
			<span>传感器加速度信息管理</span>
		</div>

	<%-- 	<span class="state_title">传感器名称：</span> 
		<input class="state_input"
...
<%-- 		</c:if> --%>
		...
		<div class='container'>
			<div class='table_container'>
				<div class="table_container_title">传感器加速度信息列表</div>
				<table rules=none>
					<tr>
						<th width="5%">序号</th>
						<th>传感器名称</th>
	...
	<script type="text/javascript">
		...
		function _export(){
			var url = '${pageContext.request.contextPath}/accelation/export';
	 		var form = document.forms[0];
			form.action = url;
			form.method = "POST";
			form.submit(); 
