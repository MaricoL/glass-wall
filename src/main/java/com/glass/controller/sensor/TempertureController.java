...
public class TempertureController {
	...
	public String sensorAngleListPage(Temperture entity, Integer currentPage, Map<String, Object> map,
	...
	public String tempertureCountManage(String name, Integer currentPage, Map<String, Object> map,
			HttpServletRequest request) {
		// HttpSession session = request.getSession();
		// List<String> angleList = (ArrayList) session.getAttribute("angleSession");
		// entity.setAngleList(angleList);
	...
	@ResponseBody
	public void exportHumidityList(Temperture entity, Map<String, String> map, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		List<Temperture> checkList = tempertureService.exportTemperatureList();
		String[] title = { "序号", "传感器名称", "位置名称", "Temp", "创建时间" };
		...
		for (int i = 0; i < checkList.size(); i++) {
			Temperture obj = checkList.get(i);
